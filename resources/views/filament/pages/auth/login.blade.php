            ...
            <div class="w-full max-w-[350px]">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-[0.83rem] text-slate-400 leading-relaxed">
                        Masuk ke panel admin untuk mengelola data posyandu.
                    </p>
                ...
                <p class="text-center text-[0.75rem] text-slate-400 mt-2">
                    Login sebagai Kader?
                    <a href="/kader/login" class="text-emerald-600 hover:text-emerald-700 font-semibold hover:underline ml-1">
                        Masuk sebagai Kader
                    </a>
                </p>
